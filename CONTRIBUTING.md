...
1. **Ensure CI passes.** All PRs must pass linting, tests, secret scanning, and
   dependency audits.
2. **Fill out the PR template.** Describe what changed and why.
3. **Keep PRs focused.** One logical change per PR. Large refactors should be
   discussed in an issue first.
4. **Request a review.** Tag a maintainer or let CODEOWNERS auto-assign.
5. **Address feedback.** Push fixup commits, then squash before merge if
   requested.
...
**Security vulnerabilities**: Please follow [SECURITY.md](SECURITY.md) instead
...
By contributing to ExtensionShield, you agree that your contributions will be
